...
CREATE TABLE IF NOT EXISTS `framboises`.`images` (
  ...
  CONSTRAINT `fk_images_products1`
    ...
    REFERENCES `framboises`.`products` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_images_recipes1`
    FOREIGN KEY (`recipes_id`)
    REFERENCES `framboises`.`recipes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `framboises`.`users_possesses_roles` (
  ...
  CONSTRAINT `fk_users_has_roles_users`
    ...
    REFERENCES `framboises`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_has_roles_roles1`
    FOREIGN KEY (`roles_id`)
    REFERENCES `framboises`.`roles` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `framboises`.`users_reserves_openings` (
  ...
  CONSTRAINT `fk_users_has_openings_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `framboises`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_has_openings_openings1`
    FOREIGN KEY (`openings_id`)
    REFERENCES `framboises`.`openings` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `framboises`.`openings_possesses_products` (
  ...
  CONSTRAINT `fk_openings_has_products_openings1`
    FOREIGN KEY (`openings_id`)
    REFERENCES `framboises`.`openings` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_openings_has_products_products1`
    FOREIGN KEY (`products_id`)
    REFERENCES `framboises`.`products` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `framboises`.`types_defines_products` (
  ...
  CONSTRAINT `fk_types_has_products_types1`
    FOREIGN KEY (`types_id`)
    REFERENCES `framboises`.`types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_types_has_products_products1`
    FOREIGN KEY (`products_id`)
    REFERENCES `framboises`.`products` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `framboises`.`recipes_requires_ingredients` (
  ...
  CONSTRAINT `fk_recipes_has_ingredients_ingredients1`
    ...
    REFERENCES `framboises`.`ingredients` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
