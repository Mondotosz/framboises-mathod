...
?>
    ...
    ob_start();
    ?>
    <div class="container grid grid-cols-12 gap-4 mx-auto p-5 border border-gray-200 shadow rounded-md">
        ...
        <div class="dashboard-content col-span-12 lg:col-span-10 grid grid-cols-12 h-auto">
            <?php if (!empty($component)) { ?>
                <?= $component ?>
            <?php } else { ?>
                <div class="col-span-12 grid place-items-center border border-gray-200 rounded-md shadow-sm">Empty</div>
            <?php } ?>
        </div>
    </div>
    <?php
